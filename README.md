...
A powerful [**Chrome**](https://chromewebstore.google.com/detail/youtube-playlist-search/baeeffjkofiojelomeedohofcamddkeh?authuser=0&hl=en&pli=1)/[**Firefox**](https://addons.mozilla.org/en-US/firefox/addon/youtube-playlist-search/)/[**Edge**](https://microsoftedge.microsoft.com/addons/detail/youtube-playlist-search/gilfooajjhonakmkcihfkbhiihddilak) extension that enhances YouTube playlists with advanced search, filtering, and searching by groups. Perfect for managing and navigating large playlists efficiently.
...
**Real-time Search**
  ...
  - Shows results count with filter details
...
- Watch as it auto-scroll and search all videos in the playlist
